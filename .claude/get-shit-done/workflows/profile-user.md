...
Key references:
- @/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md" "/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /root/.openclaw/workspace/polish/xander-operator/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd:dev-preferences at /root/.openclaw/workspace/polish/xander-operator/.claude/commands/gsd/dev-preferences.md"

**For CLAUDE.md profile section (if selected):**

```bash
node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /root/.openclaw/workspace/polish/xander-operator/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /root/.openclaw/workspace/polish/xander-operator/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd:dev-preferences   /root/.openclaw/workspace/polish/xander-operator/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /root/.openclaw/workspace/polish/xander-operator/.claude/CLAUDE.md
```
